/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: c65185fe989af0123673a723a0ee559f)
...
interface __BaseEnv_Env {
	...
	PASSWORD_RATE_LIMIT: RateLimit;
	GROUPME_CALLBACK_RATE_LIMIT: RateLimit;
	DELETE_RATE_LIMIT: RateLimit;
	ASSETS: Fetcher;
	TURNSTILE_EXPECTED_ACTION: "create-leaderboard";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_EXPECTED_ACTION" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "GOOGLE_MAPS_API_KEY">> {}
}
...
type AiOptions = {
    ...
    websocket?: boolean;
    /**
     * Tag your requests to group and view them in Cloudflare leaderboard.
     *
     * Rules:
